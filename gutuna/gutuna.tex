...
\usepackage{Sweave}
\begin{document}
\input{gutuna-concordance}
\textit{Sukarrietan, 2016ko Otsailaren 12an}\\
...
Matematikako lizentziatura 2012an bukatu nuen EHUn, estatistika eta ikerkuntza operatibo arloen inguruko interes bereziarekin. Urte horretan bertan Basurtu ospitaleko ikerketa unitatean praktikak egiteko aukera izan nuen bioestatistikari gisa eta ikasitakoari jarraipena eman eta sakontzeko asmoz Bartzelonara jo nuen. Bertan 120 kredituko 'Master en Estadística e Investigación Operativa' ikasketak egin nituen \textit{Universtitat Politècnica de Catalunya}n. Bioestatistika eta programazio matematikoko irakasgaiak landu nituen batez ere eta azken urtean, programazio estokastikoko iraskaleen bitartez, \textit{Insitut de Recerca de Rnergía de Catalunya} zentruan lan egiteko aukera izan nuen. \\

Masterreko tesia hango ikertzaile batek zuzendu zuen eta bertako beste ikertzaile batzuekin lan egiteko aukera ere izan nuen. Ikerketa zentru bateko dinamika ikusi eta egiten dituzten ekarpenak gertutik ezagutzeko aukera ona izan zen. Gure kasuan, energia kudeatzeko arazo erreal bati aurre egiteko optimizazio eredu estokastiko bat garatu genuen. Egindako lanetik artikulu bat atera genuen EMM15 kongresuan aurkeztu zena eta bertako 'proceedings' ean argitaratu zen.  \\
